...
registry.register(
    ...
    schema={
        ...
        "description": (
            ...
            "A SINGLE button/menu is an immediate choice. Several buttons of the same "
            "kind (or one select menu) are all query options; each click comes back to "
            "the agent as a user message keyed by question_id. Use update_message "
