...
TOOLSETS = {
    ...
    "message_manage": _ts("Mattermost message management (delete, pin, unpin, search) via the live gateway adapter",
                          ["delete_message", "pin_message", "unpin_message", "search_mattermost_posts"]),
    ...
    "hermes-mattermost": _bundle(
        "Mattermost bot toolset - self-hosted team messaging (full access)",
        ["react_message", "send_interactive_message", "update_message", "ephemeral_reply",
         "delete_message", "pin_message", "unpin_message", "search_mattermost_posts"]),
